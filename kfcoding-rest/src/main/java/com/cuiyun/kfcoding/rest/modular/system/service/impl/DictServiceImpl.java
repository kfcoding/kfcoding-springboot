...
import com.cuiyun.kfcoding.rest.modular.system.service.IDictService;
...
import static com.cuiyun.kfcoding.rest.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new KfCodingException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new KfCodingException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }

...
public class KfCodingGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/kfcoding?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.cuiyun.kfcoding.admin.common.persistence.model");
        packageConfig.setMapper("com.cuiyun.kfcoding.admin.common.persistence.dao");
        packageConfig.setXml("com.cuiyun.kfcoding.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.cuiyun.kfcoding.rest");

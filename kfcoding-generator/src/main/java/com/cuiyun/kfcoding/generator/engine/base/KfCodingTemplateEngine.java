package com.cuiyun.kfcoding.generator.engine.base;
 ...
 */
public abstract class KfCodingTemplateEngine extends AbstractTemplateEngine {

    private GroupTemplate groupTemplate;

    public KfCodingTemplateEngine() {
        initBeetlEngine();
    }

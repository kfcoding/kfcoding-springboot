package com.cuiyun.kfcoding.generator.action.config;
...
import com.cuiyun.kfcoding.generator.engine.SimpleTemplateEngine;
import com.cuiyun.kfcoding.generator.engine.base.KfCodingTemplateEngine;
import com.cuiyun.kfcoding.generator.engine.config.ContextConfig;
import com.cuiyun.kfcoding.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doKfCodingGeneration() {
        KfCodingTemplateEngine KfCodingTemplateEngine = new SimpleTemplateEngine();
        KfCodingTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        KfCodingTemplateEngine.setSqlConfig(sqlConfig);
        KfCodingTemplateEngine.setTableInfo(tableInfo);
        KfCodingTemplateEngine.start();
    }
}
